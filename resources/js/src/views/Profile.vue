<template>
    <div>
        <b-form @submit.prevent="update">
            <b-form-group label="الاسم بالكامل" label-for="full_name">
                <b-form-input id="full_name" v-model="form.name" />
            </b-form-group>
            ...
            <b-form-group label="الدولة" label-for="country">
                <b-form-select id="country" v-model="form.country">
                    <b-form-select-option hidden selected :value="form.country">
                        {{ form.country }}
            ...
            <b-form-group label="عمولة التسجيل" label-for="reg_commission">
                <b-form-input
                    id="reg_commission"
                    :value="reg_commission"
                    disabled
                />
            </b-form-group>
            <b-form-group label="عمولة الاشتراك" label-for="sub_commission">
                <b-form-input
                    id="sub_commission"
            ...
            <b-form-group label="حساب فيسبوك" label-for="facebook_acc">
                <b-form-input id="facebook_acc" v-model="form.facebook_acc" />
            </b-form-group>
            <b-form-group label="حساب تويتر" label-for="twitter_acc">
                <b-form-input id="twitter_acc" v-model="form.twitter_acc" />
            </b-form-group>
            <b-form-group label="حساب انستجرام" label-for="instagram_acc">
                <b-form-input id="instagram_acc" v-model="form.instagram_acc" />
            </b-form-group>
...
export default {
    ...
    data() {
        return {
            reg_commission: JSON.parse(localStorage.getItem("MatarMarketer"))
                .reg_commission,
            sub_commission: JSON.parse(localStorage.getItem("MatarMarketer"))
                .sub_commission,
            form: {
                name: JSON.parse(localStorage.getItem("MatarMarketer"))
                    .full_name,
                email: JSON.parse(localStorage.getItem("MatarMarketer")).email,
                phone: JSON.parse(localStorage.getItem("MatarMarketer")).phone,
                country: JSON.parse(localStorage.getItem("MatarMarketer"))
                    .country,
                address: JSON.parse(localStorage.getItem("MatarMarketer"))
                    .address,
                facebook_acc: JSON.parse(localStorage.getItem("MatarMarketer"))
                    .facebook_acc,
                twitter_acc: JSON.parse(localStorage.getItem("MatarMarketer"))
                    .twitter_acc,
                instagram_acc: JSON.parse(localStorage.getItem("MatarMarketer"))
                    .instagram_acc,
